...
test("project requireWorklogBeforeTerminal blocks Done when no worklog", async () => {
...
test("with a worklog the same move is allowed", async () => {
...
test("with the flag off, no worklog is required", async () => {
