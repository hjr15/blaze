...
export const styles = `
  ...
  .panel-fm input, .panel-fm select, .panel-title input {
    background: #0d1117; color: var(--neutral); border: 1px solid #30363d;
    border-radius: 5px; padding: 1px 4px; font: inherit; font-size: 12px; }
`;
